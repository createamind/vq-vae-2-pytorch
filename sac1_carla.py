...
def sac1_carla(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0,
    ...
    def test_agent(n=1):
        ...
        for j in range(n):
            ...
            while not (d or (ep_len == 600)):  # max_ep_len
...
if __name__ == '__main__':
    ...
    sac1_carla(env_fn, actor_critic=core.mlp_actor_critic,
               ac_kwargs=dict(hidden_sizes=[320, 256]),
               gamma=args.gamma, seed=args.seed, epochs=args.epochs, steps_per_epoch=args.steps_per_epoch,
               alpha=args.alpha,
